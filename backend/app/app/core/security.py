...
def create_access_token(*, subject: Union[str, Any], expires_delta: timedelta = None, force_totp: bool = False) -> str:
    if expires_delta:
        ...
        expire = datetime.now(ZoneInfo("UTC")) + timedelta(seconds=settings.ACCESS_TOKEN_EXPIRE_SECONDS)
...
def create_refresh_token(*, subject: Union[str, Any], expires_delta: timedelta = None) -> str:
    if expires_delta:
        ...
        expire = datetime.now(ZoneInfo("UTC")) + timedelta(seconds=settings.REFRESH_TOKEN_EXPIRE_SECONDS)
