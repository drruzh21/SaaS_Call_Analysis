    ...
    <header>
        ...
        <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <img class="block h-8 w-auto lg:hidden" src="https://tailwindui.com/img/logos/mark.svg?color=rose&shade=600" alt="Ridgeside AI" />
                <img class="hidden h-8 w-auto lg:block" src="https://tailwindui.com/img/logos/mark.svg?color=rose&shade=600" alt="Ridgeside AI" />
                </div>
